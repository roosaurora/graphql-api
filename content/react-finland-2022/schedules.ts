    ...
    },
    {
      ...
      sessions: [
        ...
        },
        {
          ...
          description: "Single Page Applications (SPAs) lack in accessibility by default. While a sighted user is able to tell the difference between different types of page updates, screen reader users might not separate the ones that resemble page loads from those that affect a single component. In my speech, I’ll introduce some techniques to tackle this problem.",
          people: [people.roosa],
          urls: {
            video: "",
          },
